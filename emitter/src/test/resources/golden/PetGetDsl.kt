...
public fun ScenarioBuilder.petGet(block: PetGetCall.() -> Unit = {}): PetGetCall =
    PetGetCall(this).apply(block)

@WirespecScenarioDsl
public class PetGetCall internal constructor(scenario: ScenarioBuilder) {
    @PublishedApi internal val inner = scenario.endpoint(PetGet.Handler)
