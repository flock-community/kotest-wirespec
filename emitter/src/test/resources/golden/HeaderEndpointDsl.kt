...
public fun ScenarioBuilder.headerEndpoint(block: HeaderEndpointCall.() -> Unit = {}): HeaderEndpointCall =
    HeaderEndpointCall(this).apply(block)

@WirespecScenarioDsl
public class HeaderEndpointCall internal constructor(scenario: ScenarioBuilder) {
    @PublishedApi internal val inner = scenario.endpoint(HeaderEndpoint.Handler)
