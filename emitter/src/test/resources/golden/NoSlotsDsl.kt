...
public fun ScenarioBuilder.noSlots(block: NoSlotsCall.() -> Unit = {}): NoSlotsCall =
    NoSlotsCall(this).apply(block)

@WirespecScenarioDsl
public class NoSlotsCall internal constructor(scenario: ScenarioBuilder) {
    @PublishedApi internal val inner = scenario.endpoint(NoSlots.Handler)
