...
public fun ScenarioBuilder.petList(block: PetListCall.() -> Unit = {}): PetListCall =
    PetListCall(this).apply(block)

@WirespecScenarioDsl
public class PetListCall internal constructor(scenario: ScenarioBuilder) {
    @PublishedApi internal val inner = scenario.endpoint(PetList.Handler)
